package com.qnocks.shorty.analytics_service.config;
...
public class KafkaTopicsProperties {
    ...
    public String dltName(String key) {
        String dltName = topic(key).dltName;

        if (!StringUtils.hasText(dltName)) {
            throw new IllegalStateException("Missing kafka DLT configuration for key: " + key);
        }
